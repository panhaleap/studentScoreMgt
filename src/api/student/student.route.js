...
import { getStudentList, createStudent, getStudentById, updateStudentById, deleteStudentById, createScoresForStudentById, getListStudentReport } from './student.api';
...
studentRoute.get(`${endpoint}report`, getListStudentReport);
